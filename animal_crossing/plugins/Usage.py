...
bot的QQ号为：2750447037
加好友后输入 /帮助 命令查看帮助文档
详细在线文档：https://docs.qq.com/slide/DVEttRnhzY0RMdmZz"""

COMMANDLIST = """详细在线文档：https://docs.qq.com/slide/DVEttRnhzY0RMdmZz
帮助文档：
/查看  
说明：查看所有岛
--------------------
/开门 (需私聊)
说明：需要提供岛密码和大头菜价格
格式2：/开门 岛密码|备注|最大登岛人数(可选，默认""" + str(config.DEFAULT_CAPACITY) + """"人)
